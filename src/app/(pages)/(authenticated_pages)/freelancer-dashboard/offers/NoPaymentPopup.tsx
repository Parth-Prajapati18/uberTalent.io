...
export default function NoPaymentPopup({
  showNoPaymentModal,
  setShowNoPaymentModal,
}: Props) {
  const cancelButtonRef = useRef(null);
  return (
    <Transition.Root show={showNoPaymentModal} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-10"
        initialFocus={cancelButtonRef}
        onClose={setShowNoPaymentModal}
      >
        <Transition.Child
          as={Fragment}
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Please set up your Stripe Connect account to accept an
                        offer and collect payments.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                  <Link
                    ...
                    onClick={() => setShowNoPaymentModal(false)}
