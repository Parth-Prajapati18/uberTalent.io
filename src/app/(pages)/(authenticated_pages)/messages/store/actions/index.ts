...
interface CreateNewConvo {
  type: ActionType.CREATE_NEW_CONVO,
  payload: {newConvoTitle: string, newConvoParticipantEmail: string, defaultMessage?: string};
}
interface ClearNewConvoState {
  type: ActionType.CLEAR_NEW_CONVO_STATE,
}
