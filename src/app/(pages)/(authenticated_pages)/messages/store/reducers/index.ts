...
import newConvoReducer, { NewConversationState } from "./newConvoReducer";
...
export const initialState = {
  ...
  local: "",
  newConvo: { newConvoTitle: "", newConvoParticipantEmail: "", defaultMessage: "" },
};
