...
type Props = {
  ...
  setShowOnHoldModal: Dispatch<SetStateAction<boolean>>;
};
export default function OnHoldPopup({
  showOnHoldModal,
  setShowOnHoldModal,
}: Props) {
  const cancelButtonRef = useRef(null);
  return (
    <Transition.Root show={showOnHoldModal} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-10"
        initialFocus={cancelButtonRef}
        onClose={setShowOnHoldModal}
      >
        <Transition.Child
          as={Fragment}
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Your profile is currently on hold. Please contact
