              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to {userType === 'FREELANCER' ? 'end' : 'end'} this contract?
                      </p>
                    </div>
                  </div>
                </div>
                <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse justify-center">
                  <button
                    ...
                    onClick={() =>
                      contractId && handleContractAction(contractId, "close")
                    }
                  >
                    {userType === 'FREELANCER' ? 'End' : 'End'} Contract
                  </button>
                  <button
                    type="button"
